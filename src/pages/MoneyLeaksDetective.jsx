...
export default function MoneyLeaksDetective() {
  ...
  async function handleDownload() {
    ...
    try {
      ...
      link.download = `subguard-leaks-report-${format(new Date(), 'yyyy-MM-dd')}.png`
  ...
  function handleCopyReport() {
    ...
    const text = `
SubGuard Money Leaks Report — ${format(new Date(), 'MMMM d, yyyy')}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
Generated by SubGuard — Stop getting charged for things you forgot about.
`.trim()
    ...
    <div className="space-y-8">
      ...
      <div ref={reportRef} className="space-y-6">
        ...
        >
          ...
          <p className="text-5xl font-black text-slate-100">{formatCurrency(totalMonthly)}</p>
          <p className="text-slate-500 mt-1 text-sm">{formatCurrency(totalYearly)}/year across {active.length} active charges</p>
        </motion.div>
